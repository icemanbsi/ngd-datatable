...
u=6
return P.li(W.kN("https://icemanbsi.github.io/ngd-datatable/data/simple.json"),$async$b0)
case 6:o=b
p.b=H.cH(C.x.cL(0,o))
s=1
u=5
...
r=4
u=7
return P.li(W.kN("https://icemanbsi.github.io/ngd-datatable/data/simple.json"),$async$ak)
case 7:n=b
m=H.cH(C.x.cL(0,n))
o.d=J.aJ(m)
